...
class WrappedModel(ModelWrapper):
    def forward(self, x: Tensor, t: Tensor, **extras) -> Tensor:
        ...
        return torch.softmax(self.model(input_ids=x, timesteps=t).logits, -1)
...
def generate_samples(
    ...
    sample = solver.sample(
        ...
        time_grid=torch.tensor([0.0, 1.0 - time_epsilon]).bfloat16(),
    )
    ...
    if sample_dir is not None:
        ...
        file_name = os.path.join(sample_dir, f"sample_{rank}.txt")
